...
//     set_vars(build_target, ndk, target_sdk_version, &build_target_dir)?;
...
//             // Generate source file that will be built and determine the name of the temporary file
//             let tmp_file = temporary_lib_file(&path)?;

//             // Replace source argument
//             let new_args =
//                 manage_source_argument(&path, tmp_file, &self.build_target_dir, target, cmd)?;

//             add_needed_arguments(
//                 &self.ndk,
//                 &self.build_target,
...
// /// Generate source file that will be built and determine the name of the temporary file
// fn temporary_lib_file(path: &Path) -> CargoResult<NamedTempFile> {
//     let original_src_filepath = path.canonicalize()?;

//     // Generate source file that will be built and
...
// /// Replace source argument and returns collection of arguments
